...
static int readPacket(MQTTClient *c, Timer *timer) {
    ...
    if (c->keepAliveInterval > 0)
        TimerCountdown(
            &c->last_received, c->keepAliveInterval); // record the fact that we have successfully received a packet
exit:
    return rc;
}
...
int cycle(MQTTClient *c, Timer *timer) {
    ...
    default:
        ...
        rc = packet_type;
        goto exit;
    case 0: /* timed out reading packet */ break;
    case CONNACK:
    case PUBACK:
    case SUBACK:
    case UNSUBACK: break;
    ...
    case PUBREL: {
        ...
        if (MQTTDeserialize_ack(&type, &dup, &mypacketid, c->readbuf, c->readbuf_size) != 1)
            ...
            (len = MQTTSerialize_ack(c->buf, c->buf_size, (packet_type == PUBREC) ? PUBREL : PUBCOMP, 0, mypacketid)) <= 0)
            rc = FAILURE;
    ...
    case PUBCOMP: break;
    case PINGRESP: c->ping_outstanding = 0; break;
    }
