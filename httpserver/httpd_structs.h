...
enum HTTPHeaderStrings {
    ...
    HTTP_HDR_CONTENT_LENGTH, /* Content-Length: (HTTP 1.0)*/
    HTTP_HDR_CONN_CLOSE,     /* Connection: Close (HTTP 1.1) */
    HTTP_HDR_CONN_KEEPALIVE, /* Connection: keep-alive (HTTP 1.1) */
    HTTP_HDR_KEEPALIVE_LEN,  /* Connection: keep-alive + Content-Length: (HTTP 1.1)*/
    HTTP_HDR_SERVER,         /* Server: HTTPD_SERVER_AGENT */
    DEFAULT_404_HTML,        /* default 404 body */
#if LWIP_HTTPD_SUPPORT_11_KEEPALIVE
    DEFAULT_404_HTML_PERSISTENT /* default 404 body, but including Connection: keep-alive */
#endif
};
...
#if LWIP_HTTPD_SUPPORT_11_KEEPALIVE
    ,
    [DEFAULT_404_HTML_PERSISTENT] = "Connection: keep-alive\r\nContent-Length: 77\r\n\r\n<html><body><h2>404: The requested "
                                    "file cannot be found.</h2></body></html>\r\n"
#endif
};
